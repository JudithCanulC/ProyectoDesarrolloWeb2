...
require 'controladores/datosEstacion.php';
...
if (isset($_GET['PATH_INFO']))
   ...
   // echo "path" .  $_GET['PATH_INFO'];
// Obtener recurso
$recurso = array_shift($peticion);
$recursos_existentes = array('contactos', 'usuarios', 'tiposEvento', 'documentos', 'servicios', 'datosEstacion');
